  ...
  const patientList = [
    {
      ...
      flowSheet: [],
      nurseNotes: [{date:"2020-12-09", note: "A Note about the patient", key:1}, {date: "2022-11-19", note: "This patient has been here for a long time", key:2}],
    ...
    //   flowSheet: [],
    //   nurseNotes: [<Note date= {"2023-12-09"} note= "Some notes about Molly" />, <Note date= {"2023-12-19"} note= "Molly is great she is healing wahoo" />],
    //   communityAppointments: [{ date: new Date(1995, 11, 17, 3, 24, 0) }],
    // },
    // {
    //   id: 3,
    ...
    //   flowSheet: [],
    //   nurseNotes: [<Note date= {"2023-02-09"} note= "Henry is pretty sick dude" />, <Note date= {"2023-102-19"} note= "Henry is still sick gave him some advil" />],
    //   communityAppointments: [{ date: new Date(1995, 11, 17, 3, 24, 0) }],
    // },
    // {
    //   id: 4,
    ...
    //   flowSheet: [],
    //   nurseNotes: [<Note date= {"2023-03-03"} note= "Gave Sally some meds" />, <Note date= {"2023-03-07"} note= "Sally is going home today" />],
    //   communityAppointments: [{ date: new Date(1995, 11, 17, 3, 24, 0) }],
    // },
    // {
    //   id: 5,
    ...
    //   flowSheet: [],
    //   nurseNotes: [<Note date= {"2022-03-03"} note= "Gave Hector some meds" />, <Note date= {"2022-03-07"} note= "Hector is sick" />],
    //   communityAppointments: [{ date: new Date(1995, 11, 17, 3, 24, 0) }],
    // },
  ];
